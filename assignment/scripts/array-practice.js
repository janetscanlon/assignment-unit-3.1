...
let favoriteFoods = ['strawberry poptart', 'cake', 'mashed potatoes', 'cheeseburger'];
...
console.log('using the .length property the last animal is', lastAnimal);
...
console.log('added an entree to the beginning:', entree);
...
gems.sort();
gems.reverse();
console.log('the sorted array is now', gems);
...
colorfulGems = [].concat(gems, colors);
console.log('this is the new array', colorfulGems);
